...
Contributions to **FlorianWolters\Component\Core\Equality** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Core\Equality**:
