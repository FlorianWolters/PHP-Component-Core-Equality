...
trait ReferenceEqualityTrait
{
     ...
     *   return `false`.
     *
     * The {@see equals} method of trait {@see ReferenceEqualityTrait}
     ...
     * method returns `true` if and only if `$x` and `$y` refer to the same
